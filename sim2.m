...
nbrOfRealizations = 5; %Number of channel realizations
...
legend('Only Base Stations','Low-Complexity','Spatial Soft-Cell','Location','NorthWest')
xlabel('QoS Target per User')
ylabel('Total Power per Subcarrier')
